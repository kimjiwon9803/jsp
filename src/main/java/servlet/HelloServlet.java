 ...
 * 2.클라이언트의 요청을 받아 처리하기 위한 doGet() 혹은 dePost()메서드를
 * 오버라이딩한다.
 * 3.서블릿에 필수적인 패키지 임포트와 예외처리는 자동완성된다.
 * 4.request내장객체를 사용할떄는 매개변수 req를 이용한다. response는 resp로
 * 사용하면 된다.
 * */
...
public class HelloServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -7291725014071800740L;
